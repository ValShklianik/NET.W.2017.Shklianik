...
namespace Task1.Solution
{
    public class PasswordCheckerService
    {
        ...
        public delegate Tuple<bool, string> Checker(string password);

        public void AddChecker(Checker checker) => checkers += checker;
        ...
        public Tuple<bool, string> VerifyPassword(string password)
        {
            ...
            if (checkers != null)
            {
                var results = checkers.GetInvocationList().Select(x => (Tuple<bool, string>)x.DynamicInvoke(password));
